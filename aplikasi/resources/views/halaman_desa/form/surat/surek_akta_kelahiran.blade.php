    ...
    <section class="container forms">
        <div class="form register">
            <div class="form-content">
                <header>Pengajuan Surat Rekomendasi Pembuatan Akta Kelahiran</header>
                <form action="#" method="#">
                    <br>
                    <div id="#"> <!-- Isi Form -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Surat Kelahiran Rumah Sakit</label>
                            <input type="file" class="form-control" name="scan_kelahiran_rumah_sakit" required>
                        </div>
                    </div> <!-- End -->
