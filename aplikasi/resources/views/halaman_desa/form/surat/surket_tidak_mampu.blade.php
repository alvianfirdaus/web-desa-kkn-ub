    ...
    <section class="container forms">
        <div class="form register">
            <div class="form-content">
                <header>Pengajuan Surat Keterangan Tidak Mampu</header>
                <form action="#" method="#">
                    <br>
                    <div id="#"> <!-- Isi Form -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="alasan_permohonan" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Scan Surat Pengantar RT</label>
