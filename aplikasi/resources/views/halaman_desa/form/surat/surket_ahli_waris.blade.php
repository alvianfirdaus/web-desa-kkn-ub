    ...
    <section class="container forms">
        <div class="form register">
            <div class="form-content">
                <header>Pengajuan Surat Keterangan Ahli Waris</header>
                <form action="#" method="#">
                    <br>
                    <div id="#"> <!-- Isi Form -->
                        <div class="mb-3">
                            <label class="form-label">Nama Pewaris</label>
                            <input type="text" class="form-control" name="nama_pewaris" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Scan Surat Kematian Pewaris</label>
                            <input type="file" class="form-control" name="scan_kematian_pewaris" required>
                        </div>
                    </div> <!-- End -->
