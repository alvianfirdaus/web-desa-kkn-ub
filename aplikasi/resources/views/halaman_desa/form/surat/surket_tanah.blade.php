    ...
    <section class="container forms">
        <div class="form register">
            <div class="form-content">
                <header>Pengajuan Surat Keterangan Tanah</header>
                <form action="#" method="#">
                    <br>
                    <div id="#"> <!-- Isi Form -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="lokasi_tanah" required>
                        </div>                    
                        <div class="mb-3">
                            <label class="form-label">Scan Bukti Kepemilikan</label>
                            <input type="file" class="form-control" name="scan_kepemilikan_tanah" required>
                        </div>
                    </div> <!-- End -->
