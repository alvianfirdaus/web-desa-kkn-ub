    ...
    <section class="container forms">
        <div class="form register">
            <div class="form-content">
                <header>Pengajuan Surat Keterangan Perceraian</header>
                <form action="#" method="#">
                    <br>
                    <div id="#"> <!-- Isi Form -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Nama Mantan Pasangan</label>
                            <input type="text" class="form-control" name="#" required>
                        </div>                    
                        <div class="mb-3">
                            <label class="form-label">Surat Pengadilan (Opsional)</label>
