    ...
    <section class="container forms">
        <div class="form register">
            <div class="form-content">
                <header>Pengajuan Surat Izin Keramaian</header>
                <form action="#" method="#">
                    <br>
                    <div id="#"> <!-- Isi Form -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="jenis_acara" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="jumlah_peserta" required>
                        </div>                    
                        <div class="mb-3">
                            <label class="form-label">Surat Pengantar RT</label>
                            <input type="file" class="form-control" name="scan_pengantar_rt" required>
                        </div>
                    </div> <!-- End -->
